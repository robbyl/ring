(function ($) {
    Galleria.addTheme({
        ...
        init: function (options) {
            ...
            var gallery = this, document = window.document, lang = options._locale, canvSupport = "getContext"in document.createElement("canvas");
            (function () {
                if (!canvSupport) {
                ...
                var dim = 24, canvas = document.createElement("canvas"), ctx = canvas.getContext("2d"), radius = function (degrees) {
            ...
            (function () {
                ...
                var elem = document.createElement("canvas"), ctx = elem.getContext("2d"), M = Math, _restore = function (ctx, size, back) {
                    var n = back ? -2 : 2;
                    ctx.translate(size / n, size / n)
                }, step = 28;
                $(elem).hide().appendTo(gallery.get("loader")).fadeIn(500);
                var draw = function (ctx, st) {
                    var size = 48, lines = 28, l;
            ...
            var infoState = Galleria.IE < 9 ? {bottom: -100} : {
                bottom: -50,
                opacity: 0
            ...
            this.addIdleState(this.get("info"), infoState, Galleria.IE < 9 ? {} : {opacity: 1}, true).addIdleState(this.get("image-nav-left"), {
                opacity: 0,
                left: 0
            }, {opacity: 1}, true).addIdleState(this.get("image-nav-right"), {
                opacity: 0,
                right: 0
            }, {opacity: 1}, true).addIdleState(this.get("counter"), counterState, Galleria.IE < 9 ? {} : {opacity: .9}, true);
